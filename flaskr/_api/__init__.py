...
from flaskr._calculator import calculator_api_v1
from flaskr._answers import answers_api_v1
...
CORS(news_api_v1)
api_v1.register_blueprint(calculator_api_v1)
CORS(calculator_api_v1)
api_v1.register_blueprint(answers_api_v1)
CORS(answers_api_v1)
